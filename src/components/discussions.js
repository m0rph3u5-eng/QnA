...
export default function Discussions() {
  ...
  return (
    ...
    <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols sm:gap-4 sm:px-6">
       <form className="w-full max-w-xl bg-white rounded-lg px-4 pt-2">
          <div className="flex flex-wrap -mx-3 mb-6">
             ...
             <div className="w-full md:w-full flex items-start md:w-full px-3">
                ...
                <div className="-mr-1">
                   <input type='submit' onClick={submit} className="bg-white text-gray-700 font-medium py-1 px-4 border border-gray-400 rounded-lg tracking-wide mr-1 hover:bg-gray-100" value='Post Comment'>
               </input>
                </div>
             </div>
             </div>
